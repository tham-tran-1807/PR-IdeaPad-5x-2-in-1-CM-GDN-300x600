...
lib.ssMetadata = [
		{name:"PR_IdeaPad_5x_2_in_1_CM_GDN_300x600_atlas_1", frames: [[1799,0,50,50],[0,0,300,600],[893,448,266,312],[604,559,285,287],[1195,0,300,351],[1497,0,300,339],[893,0,300,446],[1497,341,300,333],[1195,353,282,295],[302,0,300,600],[604,0,287,557]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_5x_2_in_1_CM_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPad5x2in1CMGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.mc_mui_ten_xoay).wait(350).to({_off:false},0).to({y:11},12).wait(28));
	...
	this.instance_2.setTransform(13,134);
	...
	this.instance_3.setTransform(0,134);
	...
	this.instance_4.setTransform(0,134);
	...
	this.instance_7.setTransform(5,135);
	...
	this.instance_8.setTransform(17,134);
...
// library properties:
lib.properties = {
	id: 'C8764BF0BE33D049A571455099ADB4D4',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_5x_2_in_1_CM_GDN_300x600_atlas_1.png", id:"PR_IdeaPad_5x_2_in_1_CM_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['C8764BF0BE33D049A571455099ADB4D4'] = {
